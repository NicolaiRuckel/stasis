...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="page-container svelte-3ira9l"><nav class="links-nav svelte-3ira9l"><div class="nav-title svelte-3ira9l">On this page</div> <ul class="svelte-3ira9l"><!--[-->`);
    const each_array = ensure_array_like(sections);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let section = each_array[$$index];
      $$renderer2.push(`<li class="svelte-3ira9l"><button${attr_class("svelte-3ira9l", void 0, { "active": activeSection === section.id })}>${escape_html(section.title)}</button></li>`);
    }
    $$renderer2.push(`<!--]--></ul></nav> <main class="content svelte-3ira9l"><h1 class="svelte-3ira9l">Configuration</h1> <section id="overview" class="svelte-3ira9l"><h2 class="svelte-3ira9l">Overview</h2> <p class="svelte-3ira9l">Stasis uses a <code class="svelte-3ira9l">.rune</code> configuration file located at <code class="svelte-3ira9l">$XDG_CONFIG_HOME/stasis/stasis.rune</code> (typically <code class="svelte-3ira9l">~/.config/stasis/stasis.rune</code>).
